  ...
  sort()
{
 ...
 navigateToEditor(dd,leftv,rightv,toi){
   console.log(dd)
       ...
       window.open("https://mattersmith5.embeddedexperience.com/#/editor?+fileid="+dd,"_blank",strWindowFeatures)
 ...
 gotoCharts()
 {
   ...
   var strWindowFeatures = "location=yes,height=700,width=1000,scrollbars=yes,status=yes";
    window.open("https://mattersmith5.embeddedexperience.com/#/charts","_blank",strWindowFeatures)
...
selctedDocumentCmpId(id){
 ...
 public viewResultStatus:boolean = false;
  ...
  ViewResultComparison(id)
  {
    ...
    var strWindowFeatures = "location=yes,height=500,width=800,scrollbars=yes,status=yes";
     window.open("https://mattersmith5.embeddedexperience.com/#/editor?+fileid="+id,"_blank",strWindowFeatures)
  }
  uncheckFolder()
  {
...
if(nodeInfo.length > 0){
  ...
  window.open("https://mattersmith4.embeddedexperience.com/#playbook_openOid="+oid+"&filter_includeManual="+oid+"&select="+oid+"&v=1&path="+attach,'_blank');
}
else{

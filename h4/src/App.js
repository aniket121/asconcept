...
export class App {
    ...
    _setupGraphService() {
        ...
        if("mock" in hashValues || "mockInstanceGraph" in hashValues || "mockSchemaGraph" in hashValues) {
            if(!("mockInstanceGraph" in hashValues)) { hashValues["mockInstanceGraph"] = "https://mattersmith4.embeddedexperience.com/api"+"/graph"; }
            if(!("mockSchemaGraph"   in hashValues)) { hashValues["mockSchemaGraph"]   = "https://mattersmith4.embeddedexperience.com/api" + "/schema/graph"; }
